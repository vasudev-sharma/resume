...
%------RELEVANT COURSEWORK-------
\section{\faChalkboardTeacher \ Relevant Coursework}
    %\resumeSubHeadingListStart
        \begin{multicols}{4}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Teaching Assistant}{Toronto, Canada}
        ...
        % \resumeSubHeadingListStart
        \resumeSubSubheading{\href{https://chanb.github.io/teaching/\#:~:text=Introduction\%20to\%20Machine\%20Learning\%20\%2D\%20CSCC11\%20(Winter\%202022)}{\faLink CSCC11:Introduction to Machine Learning }}{Winter 2022}{}{}
        \resumeSubSubheading{ \href{http://www.brianharrington.net/\#:~:text=I\%20am\%20currently\%20Teaching\%20CSCA08\%20\%2D\%20Introduction\%20to\%20Computer\%20Programming}{\faLink CSCA20: Introduction to programming }}{Fall 2021}{}{}
    %   \resumeItemListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem {Developed an open source software     \href{https://github.com/neuropoly/axondeepseg }{AxonDeepSeg \faGithub} - Axon / Myelin segmentation using Deep Learning.}
    ...
    {Visiting Deep Learning Research Intern}{Toulouse, France}
        \resumeItemListStart
            ...
            \resumeItem{Experimented the study; \textit{"In Alpha Oscillations strong perceptual echoes exist at 10Hz frequency"} with various architectures - 1D CNN, LSTM, WaveNet, Conv-LSTM, ARIMA, and an ensemble of these models.  \href{https://github.com/vasudev-sharma/DeepEEG-Forecast}{\faGithub}}
        \resumeItemListEnd
  \resumeSubHeadingListEnd
\vspace{-16pt}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{\href{https://github.com/vasudev-sharma/multimed}{DiSCeRn: \ \faGithub} Disease-Contrastive Representations from Multi-Modal Data } $|$ \emph{Python, PyTorch}}{December 2021}
          \resumeItemListStart
            \resumeItem{ Leveraging self-supervised contrastive learning MoCo, we proposed DisCeRn, a framework for learning representations from multi-modal medical data for representation learning.}
            \resumeItem{ Set up baselines and evaluation metrics for fine-tuning DiSCeRn on CheXPert, MIMIC and MIMIC-CXR dataset.}
            \vspace{-13pt}
            \resumeItemListEnd
